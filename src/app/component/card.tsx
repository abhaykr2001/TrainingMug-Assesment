...
// import { SlLikePlaceholder } from "react-icons/sl";
  ...
  return (
    <div className="h-full border-2 border-gray-800 border-opacity-60 rounded-lg overflow-hidden flex flex-col justify-between">
      ...
      <div className="flex items-center justify-between flex-wrap px-3 py-2">
        ...
        <button onClick={handleToggleLike} className="text-gray-400 inline-flex items-center leading-none text-4xl cursor-pointer">{isPostLiked ?  <SlDislike />:
 <SlLike/>}</button>
